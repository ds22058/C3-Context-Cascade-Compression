#!/bin/bash
# C3 v2.2 Phase 1: Freeze decoder, train encoder + Q + mm_projector
...
DATA_PATH=${DATA_PATH:-"./data/processed_v22/phase1_train.jsonl"}
OUTPUT_DIR=${OUTPUT_DIR:-"./output/phase1_v22"}
...
export WANDB_RUN_NAME=${WANDB_RUN_NAME:-"phase1-v22-latent${LATENT_TOKEN_LEN}-lr${LEARNING_RATE}-ep${NUM_EPOCHS}"}

EFFECTIVE_BATCH=$((BATCH_SIZE * GRAD_ACCUM * NUM_GPUS))

echo "============================================"
echo "  C3 v2.2 Phase 1: Encoder Training (8k)"
echo "============================================"
