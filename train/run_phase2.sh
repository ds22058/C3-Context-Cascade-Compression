#!/bin/bash
# Phase 2: Unfreeze all, decoder with low lr
...
PHASE1_CHECKPOINT=${PHASE1_CHECKPOINT:-"./output/phase1_v2/checkpoint-20000"}
DATA_PATH=${DATA_PATH:-"./data/processed/phase2_train.jsonl"}
OUTPUT_DIR=${OUTPUT_DIR:-"./output/phase2_v2"}
...
export WANDB_RUN_NAME=${WANDB_RUN_NAME:-"phase2-dlr${DECODER_LR_RATIO}-lr${LEARNING_RATE}-ep${NUM_EPOCHS}"}

echo "============================================"
echo "  C3 v2 Phase 2: Full Model Fine-tuning"
echo "============================================"
